...
public class Cus_RadioGroup extends LinearLayout {
    private ArrayList<View> mCheckables = new ArrayList<View>();

    public Cus_RadioGroup(Context context) {
        super(context);
    }

    public Cus_RadioGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Cus_RadioGroup(Context context, AttributeSet attrs, int defStyle) {
